...
- Registry synchronization: the national registry now recognizes filesystem-backed generated pages that are absent from the broad sitemap, without treating ungenerated launch-map candidates as pages. It records 3,458 known destinations, 3,382 live pages and 76 hopper records. White River's two local destinations are isolated in submitted packet `release-reconciliation-in-indianapolis-01`; the claim is bound to the existing OpenTask assignment, issue #53 and PR #54. Anchorage's three already-completed destinations are submitted under issue #57 and PR #29 with registry coordination in PR #58. Wilmington's two are submitted under issue #59 and PR #30 with registry coordination in PR #60. Atlanta's three generated routes are isolated in submitted packet `release-reconciliation-ga-atlanta-01`, bound to issue #61 and original nationwide PR #1 with registry coordination in PR #62, but reconciliation classifies all three as blocked stale research placeholders until scoped generation resolves their enriched-source identity mismatch. All ten remain non-live.
