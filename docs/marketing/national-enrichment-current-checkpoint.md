...
- Keep claim documents on schema version 1 with no undeclared fields. Review queues use structured issue/recommendation objects, with optional HTTPS source URLs; the current ledger contains 14 valid claims and 34 structured review items.
