...
- Registry synchronization: the national registry now recognizes filesystem-backed generated pages that are absent from the broad sitemap, without treating ungenerated launch-map candidates as pages. It records 3,456 known destinations, 3,382 live pages and 74 hopper records. White River's two local destinations are isolated in submitted packet `release-reconciliation-in-indianapolis-01`, bound to issue #53 and PR #54. Anchorage's three already-completed destinations are submitted under issue #57 and original campaign PR #29 with registry coordination in PR #58. Wilmington's two are submitted under issue #59 and original campaign PR #30 with registry coordination in PR #60. Atlanta's three packet routes are classified duplicate/renamed under issue #61 and PR #62; permanent redirects point to the existing enriched canonical parents at `/eastside-trail`, `/chastain-park` and `/westside-park`, while accepted-claim cleanup of obsolete files remains deferred. Philadelphia's three completed destinations are isolated in submitted packet `release-reconciliation-pa-philadelphia-01`, bound to issue #63 and original campaign PR #27 with registry coordination in PR #64. The ten non-Atlanta submitted destination records remain absent from production; Atlanta closes only after production redirect verification and accepted-claim cleanup. Forest Ridge Park and Horseshoe Farm Nature Preserve no longer appear as duplicate Wake Forest candidates because their exact City of Raleigh source URLs corroborate the existing Raleigh canonicals.
