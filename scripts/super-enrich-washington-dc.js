...
parks.push(
  {
    id: "launch-md-ellicott-city-patapsco-valley-state-park",
    name: "Patapsco Valley State Park",
    city: "Ellicott City",
    state: "MD",
    citySlug: "ellicott-city",
    assetCitySlug: "ellicott-city",
    region: "Mid-Atlantic",
    lat: 39.295459,
    lon: -76.788858,
    address: "8020 Baltimore National Pike, Ellicott City, MD 21043",
    source: "https://dnr.maryland.gov/publiclands/Pages/central/patapsco.aspx",
    sourceLabel: "Maryland Department of Natural Resources",
    operator: "Maryland Park Service",
    tier: "anchor",
    summary: "Maryland's oldest state park, extending 32 miles along the Patapsco River across eight developed recreation areas with more than 200 miles of trails, waterfalls, swinging bridges, historic railroad structures, camping, fishing, paddling, picnicking, disc golf, and river access.",
    hours: "Regular park hours are 9 a.m. to sunset, with sunset times posted at each area entrance. Fishing, boat launching, and permitted hunting can use different authorized hours; confirm those activities with the park rather than assuming the day-use gate schedule applies.",
    cost: "Current day-use charges from April through October are $2 per vehicle for Maryland residents and $4 for nonresidents on weekdays, then $3 per person for residents and $5 per person for nonresidents on weekends and holidays. November through March uses a $2 resident or $4 nonresident vehicle charge. Pickall, camping, shelters, passes, and organized groups follow separate rules.",
    arrival: "Choose the recreation area before navigating. Hollofield at 8020 Baltimore National Pike is the headquarters and central overlook, but Avalon, Orange Grove, Hilton, McKeldin, Daniels, Pickall, and other trail systems use separate roads and do not function as one connected parking destination.",
    parking: "Use the official area map and its designated lots. Avalon, Hollofield, Hilton, Orange Grove, and Daniels often reach capacity on warm weekends and summer holidays; arrive early, carpool when possible, and switch to another official area if staff close a full entrance rather than waiting or parking along nearby roads.",
    restrooms: "Restrooms are concentrated in developed areas and many are seasonal. From November 1 through April 1, Maryland DNR identifies only the Avalon restroom by Shelter 104, Hilton restroom by Shelter 201, Hollofield restroom by Shelter 300, and McKeldin restroom by the contact station as available.",
    accessibility: "Official area maps identify selected accessible parking, restrooms, shelters, picnic areas, and developed routes. The wider park is a steep river valley with natural-surface trails, rocks, roots, mud, water crossings, and long distances between recreation areas, so plan around the exact area and contact the park for a current accommodation route.",
    dogs: "Pet rules vary by recreation area. Pets are allowed in Avalon, Orange Grove, Glen Artney, McKeldin, Daniels, Hilton day-use, and Hollofield under posted leash and cleanup rules; they are prohibited in Hilton campground and Pickall, while Hollofield permits pets in both day-use and campground areas.",
    family: "Playgrounds, picnic shelters, waterfalls, bridges, short hikes, river scenery, history, and family camping create many strong options, but there is no single family zone. Select one recreation area, confirm the trail distance and restroom season, and supervise children closely around unguarded water, cliffs, roads, and active rail infrastructure.",
    transit: "The park is primarily vehicle-oriented and extends across multiple counties. Regional transit may approach some surrounding communities, but it does not provide a dependable internal connection among recreation areas; rideshare visitors should choose an exact entrance and arrange a return before starting a trail.",
    need: "A generic Patapsco pin is not an arrival plan. Download the current area map before losing service, check the park status dashboard and weather, expect popular gates to close at capacity, and remember that river swimming is unguarded where permitted and prohibited at dangerous posted locations such as McKeldin Rapids.",
    photos: [
      licensedCommonsPhoto("cascade-falls", "Wkm-boldfrontiers-0003-cascade-falls-patapsco-valley-state-park.jpg", "Boldfrontiers", "CC BY 4.0"),
      licensedCommonsPhoto("orange-grove-swinging-bridge", "Patapsco Swinging Bridge 2020a.jpg", "Antony-22", "CC BY-SA 4.0"),
      licensedCommonsPhoto("mckeldin-rapids", "McKeldin Rapids - Patapsco Valley State Park (52450039317).jpg", "Andrew Parlette", "CC BY 2.0"),
      licensedCommonsPhoto("thomas-viaduct", "Rain at the Thomas Viaduct (Elkridge, MD).jpg", "Jim Kuhn", "CC BY 2.0"),
      licensedCommonsPhoto("patapsco-river", "Patapsco fg01.jpg", "Fritz Geller-Grimm", "CC BY-SA 2.5"),
      licensedCommonsPhoto("cascade-falls-trail", "Cascade Falls Trail.jpg", "Ben Myers", "CC BY 2.5"),
    ],
  },
);
...
parks.push(
  {
    id: "launch-md-wheaton-wheaton-regional-park",
    name: "Wheaton Regional Park",
    city: "Wheaton",
    state: "MD",
    citySlug: "wheaton",
    assetCitySlug: "wheaton",
    region: "Mid-Atlantic",
    lat: 39.0553034,
    lon: -77.0344707,
    address: "2000 Shorefield Road, Wheaton, MD 20902",
    source: "https://montgomeryparks.org/parks-and-trails/wheaton-regional-park/",
    sourceLabel: "Montgomery Parks",
    operator: "Montgomery Parks",
    tier: "anchor",
    summary: "A 536-acre regional park organized into distinct family, garden, nature, sports, trail, and equestrian zones, including Brookside Gardens, Brookside Nature Center, Adventure Playground, Pine Lake, a miniature train and carousel, athletic fields, and roughly 11 miles of trails.",
    hours: "Outdoor park areas are open daily from sunrise to sunset. Lighted courts close at 11 p.m.; Brookside Gardens buildings, Brookside Nature Center, the miniature train, carousel, riding stables, and other facilities keep separate schedules.",
    cost: "General park, playground, trail, Pine Lake, Brookside Gardens, and unreserved outdoor access are free. Train and carousel rides, permits, reservations, classes, concessions, and special events may charge separately.",
    arrival: "Choose the exact zone before navigating. Use Shorefield Road for Adventure Playground, Pine Lake, train, carousel, and family picnic areas; use Glenallan Avenue for Brookside Gardens or Brookside Nature Center; athletic and equestrian areas have separate approaches.",
    parking: "Free designated parking is distributed among separate zones and parking outside marked spaces is prohibited. A general park pin can place visitors far from the intended garden, playground, train, nature center, field, or trailhead.",
    restrooms: "Restrooms and drinking fountains in the Shorefield picnic area generally operate April through October. Brookside Gardens and Brookside Nature Center have building restrooms during their own hours; trails and other zones do not provide continuous service.",
    accessibility: "Brookside Gardens has accessible parking, entrances, restrooms, pathways, two first-come wheelchairs, and a mapped accessible route. The Shorefield fitness station is fully accessible, while natural trails, hills, roots, and long distances require route-specific planning.",
    dogs: "Leashed dogs are allowed in permitted outdoor park areas, and the park has a fenced dog park. Pets are not allowed in Brookside Gardens; service animals are welcome there. Buildings and ticketed attractions use their own access rules.",
    family: "Adventure Playground, the train and carousel, Pine Lake, Brookside Gardens, nature play, picnic areas, and short trails make this a strong family destination. Attraction, restroom, and building schedules differ, so confirm the exact plan before promising children a ride or indoor stop.",
    transit: "Wheaton and Glenmont Metro stations and local bus routes serve different sides of the park, but final walks vary substantially. Select transit for Shorefield, Brookside Gardens, Brookside Nature Center, or the athletic complex rather than for the park center.",
    need: "This park functions as several destinations. Shorefield picnic permits and seasonal restrooms generally run April through October, the train and carousel are seasonal and weather-dependent, and current building, construction, and weather alerts should be checked on the visit day.",
    photos: [
      photo("brookside-gardens-spring", "https://live.staticflickr.com/65535/49881511552_c42765a6c9_b.jpg", "https://www.flickr.com/photos/94359914@N06/49881511552", "John Brighenti", "CC BY 2.0"),
      photo("harper-homestead", "https://upload.wikimedia.org/wikipedia/commons/d/d0/Harper_family_homestead_wheaton_md_20200830_112402_1.jpg", "https://commons.wikimedia.org/wiki/File:Harper_family_homestead_wheaton_md_20200830_112402_1.jpg", "G. Edward Johnson", "CC BY 4.0"),
      photo("brookside-pond-island", "https://live.staticflickr.com/5334/17835481062_8829b441cb_b.jpg", "https://www.flickr.com/photos/76074333@N00/17835481062", "WorldIslandInfo.com", "CC BY 2.0"),
      photo("brookside-maple-terrace", "https://upload.wikimedia.org/wikipedia/commons/f/fe/Maple_Terrace_%2852058036121%29.jpg", "https://commons.wikimedia.org/wiki/File:Maple_Terrace_(52058036121).jpg", "John Brighenti", "CC BY 2.0"),
    ],
  },
  {
    id: "launch-md-upper-marlboro-watkins-regional-park",
    name: "Watkins Regional Park",
    city: "Upper Marlboro",
    state: "MD",
    citySlug: "upper-marlboro",
    assetCitySlug: "upper-marlboro",
    region: "Mid-Atlantic",
    lat: 38.8858532,
    lon: -76.7968941,
    address: "301 Watkins Park Drive, Upper Marlboro, MD 20774",
    source: "https://pgparks.com/parks_trails/watkins-regional-park",
    sourceLabel: "M-NCPPC Department of Parks and Recreation",
    operator: "M-NCPPC Department of Parks and Recreation",
    tier: "anchor",
    summary: "An 850-plus-acre regional park with the Wonderful Wizard of Oz Playground, Watkins Nature Center, Old Maryland Farm, Chesapeake Carousel, miniature train, mini golf, campgrounds, athletic fields, picnic shelters, trails, and seasonal events.",
    hours: "Outdoor park areas generally follow posted park hours, while Watkins Nature Center and Old Maryland Farm are closed Monday, open Tuesday-Saturday 10 a.m.-5 p.m., and Sunday 10 a.m.-4 p.m. Rides, mini golf, campgrounds, programs, and events use separate schedules.",
    cost: "General park access, the Wizard of Oz Playground, Watkins Nature Center, and Old Maryland Farm are free. Rides, mini golf, camping, permits, reservations, classes, and special events may charge separately.",
    arrival: "Use the official park map and the exact destination. Watkins Nature Center is at 331 Watkins Park Drive and Old Maryland Farm is at 351 Watkins Park Drive; the playground, train, carousel, shelters, fields, and campground sit in different internal zones.",
    parking: "Free lots are distributed by activity. Use the Nature Center lot for the nature center and bus parking for Old Maryland Farm, then follow signed internal paths; do not rely on a single central pin for every attraction.",
    restrooms: "Restrooms are mapped near developed picnic shelters, recreation zones, and staffed facilities. Building restrooms follow Nature Center and Farm hours, while seasonal or outdoor facilities can close for maintenance or winterization.",
    accessibility: "The official map identifies paved paths, accessible parking, and developed facility approaches. Watkins Nature Center lists hard- and natural-surface trail access, but exact routes, playground equipment, ride boarding, and campground surfaces require destination-specific planning.",
    dogs: "Keep dogs leashed in permitted outdoor areas and away from playgrounds, animal enclosures, rides, and active sports. Do not assume pets can enter Watkins Nature Center, Old Maryland Farm animal areas, or ticketed attractions; service animals follow applicable access rules.",
    family: "The Wizard of Oz Playground, free farm and nature center, train, carousel, mini golf, picnic shelters, and trails make this a major family destination. Confirm rides before promising them: the official park page currently reports the miniature train temporarily out of service until further notice.",
    transit: "The park is primarily vehicle-oriented. Local bus and rideshare options require a final walk through a large property, so navigate to the exact facility and arrange the return before arriving.",
    need: "The Wonderful World of Watkins miniature train is currently posted out of service until further notice. Construction, seasonal ride schedules, special events, campground operations, and building hours can change independently, so check the official alert and facility pages before leaving.",
    photos: [
      photo("oz-ruby-slipper-slide", "https://live.staticflickr.com/4270/35288143782_7c6d65d61b_b.jpg", "https://www.flickr.com/photos/13194817@N00/35288143782", "F Delventhal", "CC BY 2.0"),
      photo("oz-yellow-brick-road", "https://live.staticflickr.com/65535/35441816005_130a93f4c7_b.jpg", "https://www.flickr.com/photos/13194817@N00/35441816005", "F Delventhal", "CC BY 2.0"),
      photo("oz-rainbow-shadow", "https://live.staticflickr.com/4282/35047714200_66bebaa3a9_b.jpg", "https://www.flickr.com/photos/13194817@N00/35047714200", "F Delventhal", "CC BY 2.0"),
      photo("oz-play-equipment", "https://live.staticflickr.com/4238/34600232944_cdc03c3fc9_b.jpg", "https://www.flickr.com/photos/13194817@N00/34600232944", "F Delventhal", "CC BY 2.0"),
    ],
  },
  {
    id: "launch-md-gaithersburg-seneca-creek-state-park",
    name: "Seneca Creek State Park",
    city: "Gaithersburg",
    state: "MD",
    citySlug: "gaithersburg",
    assetCitySlug: "gaithersburg",
    region: "Mid-Atlantic",
    lat: 39.1181249,
    lon: -77.2983938,
    address: "11950 Clopper Road, Gaithersburg, MD 20878",
    source: "https://dnr.maryland.gov/publiclands/Pages/central/seneca.aspx",
    sourceLabel: "Maryland Department of Natural Resources",
    operator: "Maryland Park Service",
    tier: "anchor",
    summary: "A 6,300-acre state park extending along 14 miles of Seneca Creek, with the 90-acre Clopper Lake day-use area, more than 50 miles of trails, seasonal boat rentals, playgrounds, picnic areas, fishing, historic sites, and varied natural landscapes.",
    hours: "Park hours are 8 a.m. to sunset March through October and 10 a.m. to sunset November through February. The Boat Center, programs, offices, events, and reserved facilities keep separate seasonal schedules.",
    cost: "Most weekday day use is free. On weekends and holidays from April through October, the posted service charge is $3 per person for Maryland residents and $5 per person for out-of-state visitors; children in car or booster seats and qualifying pass holders enter free.",
    arrival: "Use 11950 Clopper Road for the Clopper Day-Use Area, lake, playground, picnics, and Boat Center. The park stretches for miles along Seneca Creek, and Black Rock Mill, trailheads, and other access points are separate from the main lake entrance.",
    parking: "Parking is distributed among the park office, lake, Boat Center, playground, picnic, and trail areas. The Black Rock parking lot is currently closed for streambank rehabilitation, so do not navigate there expecting normal vehicle access.",
    restrooms: "The park reports 11 restrooms, seven reached by paved walkways, with service concentrated in developed day-use and picnic areas. Building and seasonal restroom availability can differ from the broader park schedule.",
    accessibility: "The park has an accessible office, six accessible pavilions, accessible family picnic sites, seven restrooms reached by paved walkways, and a paved lakefront fishing route at the Boat Center. Hiking trails are unpaved and may include roots, steps, and steep slopes.",
    dogs: "Leashed pets are allowed in permitted park areas, but pets other than service animals are not permitted in rental boats. Keep pets away from wildlife, active launching, playground equipment, and any posted restricted area.",
    family: "Clopper Lake views, the Tire Playground, picnics, fishing access, seasonal boats, and shorter trails can support a full family day. Swimming and wading are prohibited in Clopper Lake, and children need close supervision at every shoreline and dock.",
    transit: "The park is primarily vehicle-oriented and spread across a large landscape. If using rideshare, select the exact day-use destination and arrange a return before entering a trail or remote historic-site area.",
    need: "Swimming and wading are prohibited in Clopper Lake. Current alerts also close the Black Rock parking lot and the bridge connection between Long Draft and Mink Hollow trails; boat operations, storm closures, trail conditions, and park alerts should be checked the same day.",
    photos: [
      photo("clopper-lake", "https://live.staticflickr.com/65535/48381603686_61773ef7e5_b.jpg", "https://www.flickr.com/photos/13194817@N00/48381603686", "F Delventhal", "CC BY 2.0"),
      photo("tire-playground", "https://live.staticflickr.com/65535/48395219896_5a8fbf186e_b.jpg", "https://www.flickr.com/photos/13194817@N00/48395219896", "F Delventhal", "CC BY 2.0"),
      photo("clopper-lake-boat-center", "https://live.staticflickr.com/65535/48403045812_f68d90aac2_b.jpg", "https://www.flickr.com/photos/13194817@N00/48403045812", "F Delventhal", "CC BY 2.0"),
      photo("black-rock-mill", "https://upload.wikimedia.org/wikipedia/commons/3/3b/Remains_of_the_Black_Rock_Mill_in_Seneca_Creek_State_Park_MD.jpg", "https://commons.wikimedia.org/wiki/File:Remains_of_the_Black_Rock_Mill_in_Seneca_Creek_State_Park_MD.jpg", "Aneta Kaluzna", "CC BY-SA 2.5"),
      photo("seneca-fall-reflections", "https://live.staticflickr.com/7524/15620725287_3357e9db03_b.jpg", "https://www.flickr.com/photos/82955120@N05/15620725287", "Bold Frontiers", "CC BY 2.0"),
    ],
  },
);
...
const wheatonRegionalPark = parks.find((park) => park.id === "launch-md-wheaton-wheaton-regional-park");
const watkinsRegionalPark = parks.find((park) => park.id === "launch-md-upper-marlboro-watkins-regional-park");
const senecaCreekStatePark = parks.find((park) => park.id === "launch-md-gaithersburg-seneca-creek-state-park");
const patapscoValleyStatePark = parks.find((park) => park.id === "launch-md-ellicott-city-patapsco-valley-state-park");
...
featureRows.push(
  [wheatonRegionalPark.id,"brookside-gardens","Brookside Gardens","garden",39.0576695,-77.0367986,"https://montgomeryparks.org/parks-and-trails/brookside-gardens/visit/","brookside-gardens-spring","A free 50-acre public display garden within Wheaton Regional Park, with themed gardens, two conservatories, a Visitor Center, accessible paths, seasonal flowers, water features, and quiet walking routes.","Use 1800 Glenallan Avenue for the Visitor Center and primary garden arrival. Brookside Gardens has its own lots and entrances and should not be approached through the Shorefield playground and train zone.","Wheelchair-accessible restrooms are in the Visitor Center and Conservatory during building hours, including an all-gender restroom in the Visitor Center.","Outdoor gardens are open sunrise to sunset. The Visitor Center is open daily 9 a.m.-5 p.m. and the Conservatory daily 10 a.m.-5 p.m.; pets are not allowed, and personal group photography may require a permit.",{ address: "1800 Glenallan Avenue, Wheaton, MD 20902", hours: "Outdoor gardens are open sunrise to sunset. The Visitor Center is open daily 9 a.m.-5 p.m.; the Conservatory is open daily 10 a.m.-5 p.m., with weather and holiday changes possible.", cost: "Garden, Visitor Center, and Conservatory admission is free. Programs, events, rentals, permits, and the gift shop use separate charges.", accessibility: "Accessible parking is available outside the Visitor Center and Conservatory, accessible paths are mapped through the gardens, building restrooms are accessible, and two wheelchairs are available first-come at the information desk.", dogs: "Pets are not allowed in Brookside Gardens. Service animals are welcome.", family: "The Children's Garden, ponds, flowers, conservatories, and short paved routes can work well for families. Closely supervise children around water and protect the living collection.", positionQuality: "OpenStreetMap Brookside Gardens object 850315465 cross-checked against the official visitor address and accessible garden map" }],
  [wheatonRegionalPark.id,"brookside-nature-center-harper-homestead","Brookside Nature Center & Harper Homestead","nature_center",39.058146,-77.032486,"https://montgomeryparks.org/parks-and-trails/brookside-nature-center/","harper-homestead","A wooded nature center area with weekend exhibits, local animal ambassadors, nature play, pond and interpretive routes, and the relocated 1870s Harper family homestead.","Use 1400 Glenallan Avenue and the Nature Center parking area. The pin identifies the photographed Harper Homestead within the Nature Center grounds; this is separate from Brookside Gardens' Visitor Center and Conservatory.","Building restrooms are available only during Nature Center hours. Outdoor grounds and trails remain open sunrise to sunset, so plan without indoor facilities outside the weekend schedule.","During the current facility-upgrade period the building is closed Monday-Friday, open Saturday 10 a.m.-4 p.m. and Sunday noon-4 p.m. Outdoor grounds and trails remain open sunrise to sunset; renovations may limit rooms, rentals, or programs.",{ address: "1400 Glenallan Avenue, Wheaton, MD 20902", hours: "Outdoor grounds and trails are open daily sunrise to sunset. During the current upgrade period, the Nature Center building is open Saturday 10 a.m.-4 p.m. and Sunday noon-4 p.m. and closed Monday-Friday except scheduled programming.", cost: "General outdoor access and drop-in building admission are free. Registered programs, camps, rentals, and events may charge separately.", accessibility: "The area includes accessible interpretive boardwalks and a reservable GRIT all-terrain chair during Nature Center hours. Contact Program Access for a specific accommodation.", dogs: "Keep dogs leashed on permitted outdoor park routes and out of animal displays, nature play, and restricted building areas. Service animals follow applicable access rules.", family: "Nature play, the pond, wildlife exhibits, and Harper Homestead are family-friendly, but the discovery room and other spaces may be affected by active renovations.", positionQuality: "Wikimedia Commons camera coordinates for the Harper Homestead cross-checked against the official Brookside Nature Center address" }],

  [watkinsRegionalPark.id,"wonderful-wizard-of-oz-playground","Wonderful Wizard of Oz Playground","playground",38.8871015,-76.7949259,"https://pgparks.com/parks_trails/watkins-regional-park","oz-ruby-slipper-slide","A large themed playground reached by a yellow-brick path, with ruby-slipper slides, colorful climbing and sensory elements, multiple play zones, and imaginative references to the Wizard of Oz.","Enter Watkins Regional Park from Watkins Park Drive, follow the official map toward Watkins Nature Center, and use the playground parking and paved approach. The playground is east of the Nature Center rather than beside the train or farm.","Use the mapped developed-area restrooms near the playground, Nature Center, and picnic zones; building restrooms follow their own hours and outdoor facilities may be seasonal.","Playground access is free during posted park hours. Surfaces and equipment can be hot or wet, shade varies, and active construction, maintenance, weather, or special events can affect access.",{ cost: "Playground access is free. Nearby rides, mini golf, reservations, programs, and events charge separately.", accessibility: "The playground has a paved approach and modern play surfacing, but not every element provides the same transfer or sensory access. Use the official map and contact the park for a specific accommodation.", dogs: "Keep pets out of the playground play surface and closely leashed in permitted surrounding park areas. Service animals follow applicable access rules.", family: "This is the park's major free play destination. Choose a meeting point, supervise across the large themed layout, and bring water because the play zones are spread out.", positionQuality: "Official 2026 park map cross-checked against OpenStreetMap playground object 383665820" }],

  [senecaCreekStatePark.id,"clopper-lake-boat-center","Clopper Lake Boat Center","boat_rental",39.1437948,-77.2504856,"https://dnr.maryland.gov/publiclands/Pages/central/seneca.aspx","clopper-lake-boat-center","The seasonal lakefront center rents canoes, single and tandem kayaks, and pedal boats, supports hand-launched private watercraft, sells limited supplies, and provides a paved fishing approach.","Enter the Clopper Day-Use Area at 11950 Clopper Road and follow internal signs toward Clopper Lake and the Boat Center lower parking area. This is not near Black Rock Mill.","Use the developed day-use and Boat Center restroom network before launching. Availability follows seasonal operations and the broader park service schedule.","The current official page lists summer Boat Center service from Memorial Day through Labor Day, closed Monday-Tuesday, with afternoon Wednesday-Friday and daytime weekend hours. Weather, thunder, training, staffing, and lake conditions can close rentals; verify the same day.",{ hours: "Current summer hours are posted as Wednesday-Friday 3-7 p.m. with last rental at 6 p.m., and Saturday-Sunday 10 a.m.-6:30 p.m. with last rental at 5:30 p.m.; Monday-Tuesday closed. Confirm same-day alerts.", cost: "Current posted boat rentals are $12 per hour. General weekend and holiday park service charges may also apply April through October.", accessibility: "A paved lakefront walkway provides fishing access at the Boat Center. Contact the park before visiting for a specific dock or boat-boarding accommodation.", dogs: "Pets other than service animals are not permitted in rental boats. Keep leashed pets clear of docks, active launching, fishing lines, and wildlife.", family: "Rental boats can work for families, but an adult age 18 or older with identification must complete the rental, life-jacket rules apply, and swimming or wading in Clopper Lake is prohibited.", positionQuality: "OpenStreetMap Boat Center building 188374459 cross-checked against the official park map and Boat Center guidance" }],
  [senecaCreekStatePark.id,"tire-playground","Tire Playground","playground",39.1460304,-77.2532214,"https://dnr.maryland.gov/publiclands/Pages/central/seneca.aspx","tire-playground","A distinctive playground in the Clopper Day-Use Area built around large recycled-tire climbing, crawling, and imaginative-play forms near picnic and lake recreation zones.","Enter the Clopper Day-Use Area from 11950 Clopper Road and follow the official day-use map toward the playground and nearby picnic parking. Do not navigate to the park's geographic center.","Use mapped developed day-use restrooms before play. Restroom availability varies by building, season, and maintenance even when the outdoor park remains open.","The outdoor playground follows park hours: 8 a.m. to sunset March-October and 10 a.m. to sunset November-February. Equipment can become hot, wet, muddy, or temporarily closed for maintenance.",{ cost: "Playground use is included with park access. Weekend and holiday service charges apply April through October under current Maryland Park Service rules.", accessibility: "The destination has a developed day-use approach, but tire structures and wood-chip or natural surfaces may not suit every mobility need. Contact the park for current route conditions.", dogs: "Keep pets out of the play equipment and closely leashed in permitted surrounding areas.", family: "The tire structures support active climbing and imaginative play, but adults should inspect wet or hot rubber, supervise openings and elevated elements, and bring water.", positionQuality: "OpenStreetMap Tire Playground object 1091199192 cross-checked against the official Seneca Creek day-use map" }],
  [senecaCreekStatePark.id,"black-rock-mill","Black Rock Mill","historic_site",39.1272451,-77.3146320,"https://dnr.maryland.gov/publiclands/Pages/central/seneca.aspx","black-rock-mill","The roofless stone remains of a historic mill stand beside Seneca Creek in a separate western park area, offering a cultural-landscape stop distinct from Clopper Lake's day-use facilities.","Do not use the Clopper Lake entrance for a mill-only visit. The Black Rock parking lot is currently closed for streambank rehabilitation, so normal vehicle arrival is not available and visitors should not improvise roadside parking.","There is no dependable staffed restroom at the mill. Use developed park facilities before approaching any remote trail or historic-site route.","The park alert currently closes the Black Rock parking lot until streambank repairs are complete. Treat the site as unavailable for ordinary vehicle arrival and check the official alert before attempting any route.",{ hours: "The surrounding park follows seasonal daily hours, but the Black Rock parking lot is currently closed until repairs are completed. A broader park schedule does not mean normal mill access is available.", cost: "There is no separate mill admission, but applicable park service charges and rules still apply. Do not park illegally to avoid the closed lot.", accessibility: "The current parking closure removes the normal arrival option, and the historic ruin and creekside terrain are not a developed accessible visitor facility. Wait for official access guidance.", dogs: "Do not take pets through a closed or improvised access. When official access resumes, keep dogs leashed and away from the ruin, creek, and restoration work.", family: "The mill can be an interesting history stop when officially accessible, but it is not currently a dependable family arrival point because the parking lot is closed.", positionQuality: "Wikimedia Commons camera coordinates and OpenStreetMap historic-site point cross-checked against the official park alert" }],
);

featureRows.push(
  [patapscoValleyStatePark.id,"cascade-falls","Cascade Falls","waterfall",39.239624,-76.751759,"https://dnr.maryland.gov/publiclands/Pages/central/PatapscoValley/Avalon/Avalon-OrangeGrove-GlenArtney.aspx","cascade-falls","A compact waterfall on Cascade Falls Trail is one of the park's most searched family hiking destinations, reached from the Avalon and Orange Grove trail network rather than the Hollofield headquarters.","Enter the Avalon area at 5120 South Street, use the official Avalon/Orange Grove map, and follow current Cascade Falls Trail signs. The waterfall is a trail destination with no vehicle access or parking at the falls.","Use the developed Avalon restroom before hiking. Maryland DNR lists the restroom by Shelter 104 as the only winter restroom in the Avalon area, and there are no facilities at the waterfall.","The falls and trail follow the park's 9 a.m.-to-sunset day-use schedule. Rocks, roots, mud, ice, creek crossings, and high water change the route; never climb wet rock or treat the pool as a guarded swimming area.",{ parking: "Park only in an open designated Avalon or Orange Grove space. These areas often close at capacity on warm weekends, so arrive early and do not use neighborhood shoulders or blocked gates as overflow parking.", cost: "Current Avalon day-use charges apply: April-October weekdays are $2 per Maryland vehicle or $4 per nonresident vehicle; weekends and holidays are $3 per Maryland resident or $5 per nonresident. Winter uses a vehicle honor charge.", accessibility: "Cascade Falls is reached by a natural-surface trail with uneven grades, roots, rocks, mud, and water-sensitive sections. It is not documented as an accessible waterfall route; contact the park for a current alternative nature experience.", dogs: "Leashed pets are allowed in Avalon and Orange Grove. Keep dogs out of the falls and swift water, yield on narrow trail, and remove waste.", family: "The waterfall can be a rewarding shorter family objective, but adults should match the full out-and-back distance to children, keep them off wet rock, and turn back when water, ice, heat, or crowding makes the route unsafe.", positionQuality: "Exact CC BY 4.0 camera coordinates cross-checked against the official Avalon/Orange Grove trail map" }],
  [patapscoValleyStatePark.id,"orange-grove-swinging-bridge","Orange Grove Swinging Bridge","bridge",39.241298,-76.749657,"https://dnr.maryland.gov/publiclands/Pages/central/PatapscoValley/Avalon/Avalon-OrangeGrove-GlenArtney.aspx","orange-grove-swinging-bridge","A pedestrian suspension bridge crosses the Patapsco River in the Orange Grove area and connects the Grist Mill and Cascade Falls trail network.","Use the Avalon entrance at 5120 South Street and the official Avalon/Orange Grove map. Walk from designated parking toward Orange Grove; the bridge cannot be reached by car and is not beside Hollofield headquarters.","Use developed Avalon facilities before walking to Orange Grove. There is no restroom on the bridge, and winter service is limited to the restroom by Avalon Shelter 104.","The bridge follows the park's 9 a.m.-to-sunset schedule and can be affected by flooding, storms, ice, maintenance, or trail closures. Cross at a walking pace, follow posted capacity rules, and do not climb or swing the structure.",{ parking: "Park only in an open designated Avalon area lot. The entrance may close when lots reach capacity, especially on summer weekends; do not block South Street, gates, or emergency access.", cost: "Avalon/Orange Grove day-use charges apply under the current Maryland Park Service schedule. The bridge has no separate ticket.", accessibility: "The bridge is approached by park paths and trail surfaces that can include grades, gravel, mud, and flood effects. Maryland DNR does not document the full bridge approach as an accessible route, so verify current conditions for a specific mobility need.", dogs: "Leashed pets are allowed in Orange Grove. Keep the leash short on the narrow moving bridge, yield to other visitors, and avoid crowding nervous animals.", family: "The moving bridge is memorable for children, but adults should keep hands and bodies inside the railings, walk rather than run, and skip the crossing when posted closed or when a child is uncomfortable with movement.", positionQuality: "Exact CC BY-SA 4.0 camera coordinates cross-checked against the official Orange Grove destination and trail map" }],
  [patapscoValleyStatePark.id,"mckeldin-rapids","McKeldin Rapids","river_feature",39.351136,-76.886873,"https://dnr.maryland.gov/publiclands/Pages/central/PatapscoValley/McKeldin/McKeldin-Area.aspx","mckeldin-rapids","A dramatic rapid at the meeting area of the Patapsco's branches is a scenic McKeldin trail destination, but the rapids and pool below are explicitly closed to swimming because of dangerous currents.","Navigate to the McKeldin area at 11676 Marriottsville Road, park in a designated open lot, and use the official McKeldin map and signed trails. The rapids are below the developed contact-station area, not a roadside stop.","Use the restroom by the McKeldin contact station before hiking. Maryland DNR identifies it as the area's dependable winter restroom; there are no facilities at the rapids.","The trail destination follows regular 9 a.m.-to-sunset hours. The rapids and pool below are closed to swimming at all times because of dangerous currents; high water, storms, ice, and trail work can also close the approach.",{ parking: "Use designated McKeldin parking near the contact station and recreation facilities. Do not park at gates or along Marriottsville Road if the area is full or closed.", cost: "Current Patapsco day-use service charges apply to McKeldin. There is no separate fee to view the rapids, while camping, shelters, and reserved activities charge separately.", accessibility: "The official McKeldin map marks selected accessible developed facilities, but the route down to the natural rapids includes trail grades and uneven surfaces. Do not infer that the rapids viewpoint is wheelchair accessible without current park confirmation.", dogs: "Leashed pets are allowed in McKeldin. Keep dogs out of the rapids and pool, away from anglers and horses, and under close control on multi-use trails.", family: "The rapids can be a compelling nature stop for older children who stay on trail and obey water closures. It is not a swimming hole; maintain direct supervision and turn around if trail or river conditions are unsafe.", positionQuality: "Exact CC BY 2.0 camera coordinates cross-checked against the official McKeldin map and Maryland DNR rapids warning" }],
  [patapscoValleyStatePark.id,"thomas-viaduct-viewpoint","Thomas Viaduct Viewpoint","historic_site",39.221474,-76.713281,"https://dnr.maryland.gov/publiclands/Pages/central/patapsco.aspx","thomas-viaduct","The 1835 Thomas Viaduct carries an active railroad across the Patapsco near the Avalon area; established ground-level views reveal its curved stone arches without entering railroad property.","Use the Avalon entrance at 5120 South Street and follow the official historic-site guidance west of the contact station. View from established park routes only; the tracks, bridge deck, and railroad right-of-way are not visitor access.","Use developed Avalon facilities before walking toward the viaduct. There is no public restroom at the structure, and winter service is limited to the restroom by Shelter 104.","Ground-level viewing follows the park's 9 a.m.-to-sunset day-use hours. The viaduct is active railroad infrastructure: never enter the tracks, climb the masonry, cross fencing, or use an apparent service route as a shortcut.",{ parking: "Park in a legal open Avalon space near the contact-station area and walk by the official park route. There is no visitor parking on the viaduct or railroad property.", cost: "Applicable Avalon day-use charges cover the park visit; there is no separate viaduct admission. Railroad property remains closed regardless of park entry payment.", accessibility: "Some developed Avalon facilities are mapped as accessible, but the exact ground-level viewpoint route can include trail surface and grade changes. Contact the park for the safest current viewpoint for a mobility need.", dogs: "Leashed pets are allowed in Avalon but must remain well away from tracks, trains, masonry edges, and narrow trail traffic.", family: "The structure is a useful history stop when viewed from a safe established route. Keep children beside an adult and make the active-railroad boundary the central rule of the visit.", positionQuality: "Exact CC BY 2.0 camera coordinates cross-checked against Maryland DNR's official historic-site description west of the Avalon contact station" }],
);
