...
const campaignPlaces = [
  ...
  },
  {
    ...
    featureResearchRadiusMeters: 4000,
    imageQueries: ["Hollywood Beach Broadwalk", "Hollywood Dog Beach", "Charnow Park Hollywood Florida", "Hollywood Beach Theatre"],
    subsites: ["Charnow Park", "Hollywood Beach Theatre", "Hollywood Dog Beach", "Johnson Street Accessible Beach Entrance", "Garfield Street Parking Garage"],
  },
];
  ...
  "launch-fl-hollywood-hollywood-beach-and-broadwalk": {
    ...
    candidates: [
      ...
      },
      {
        ...
        alt: "Signed dog-friendly beach area on Hollywood Beach",
        reviewedAt: checkedAt,
      },
      {
  ...
  "launch-fl-hollywood-hollywood-beach-and-broadwalk": [
    ...
    },
    {
      ...
      answerSources: {
        parking: { source: hollywoodMap, sourceLabel: "City of Hollywood" },
        restroom: { source: hollywoodMap, sourceLabel: "City of Hollywood" },
        accessibility: { source: hollywoodDogs, sourceLabel: "City of Hollywood Parks, Recreation and Cultural Arts" },
        dogs: { source: hollywoodDogs, sourceLabel: "City of Hollywood Parks, Recreation and Cultural Arts" },
        family: { source: hollywoodDogs, sourceLabel: "City of Hollywood Parks, Recreation and Cultural Arts" },
      },
      answers: {
        parking: "Use legal metered spaces along the north-beach streets near Pershing or Custer and read every posted restriction. The central beach garages are far from Dog Beach, so do not use a generic Hollywood Beach parking pin for this destination.",
        ...
        accessibility: "The official page does not document a firm accessible route across the sand or a beach wheelchair at this dog zone. Visitors who need mat access or mobility equipment should contact the City before traveling and consider one of the City's named accessible beach entries instead.",
...
const featureResearchQueue = {
  ...
  "launch-fl-hollywood-hollywood-beach-and-broadwalk": "Published Charnow Park, Hollywood Beach Theatre, and Hollywood Dog Beach from exact official pages, reviewed address pins, and destination-specific reusable photography. Secure exact photo-and-pin pairs before adding accessible beach mats, individual restroom buildings, public art, or separate Broadwalk entrances.",
};
