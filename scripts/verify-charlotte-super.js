...
const joined = campaign.places
  ...
  .join("\n");
for (const phrase of [
  "pond work, tree work, festivals and games",
  "This park changes character with the Uptown calendar",
  "Choose nature, ruins, disc golf, dog park or sports",
  "Low areas and greenway segments can flood",
  "This is a working sports park",
  "never cross barricades or floodwater",
  "Equestrian trails can close when wet",
  "Reserve campsites before relying on an overnight stay",
  "Monday-Saturday 9:00 a.m.-5:00 p.m. and Sunday 1:00-5:00 p.m.",
  "close when wet",
  "separately operated, ticketed attraction",
  "confirmed campsite reservation",
])
  need(joined.includes(phrase), `Missing Charlotte/Mecklenburg guidance: ${phrase}`);
...
console.log(
  `Verified ${campaign.places.length} Charlotte/Mecklenburg guides with four photos, eight mapped subsites and practical visitor answers.`,
);
