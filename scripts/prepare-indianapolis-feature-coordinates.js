...
const campaign = require("../data/indianapolis-super-enrichment-campaign.json");
const overrides = require("../data/indianapolis-coordinate-overrides.json");
...
fs.writeFileSync(path.join(root, "data/generated/indianapolis-feature-coordinates.json"), `${JSON.stringify(out, null, 2)}\n`);
