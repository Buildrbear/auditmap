...
const joined = campaign.places
  ...
  .join("\n");
for (const phrase of [
  "200-acre event landscape",
  "Banyan Courtyard and portico",
  "need advance entry reservations",
  "closed through August 18, 2026",
  "rescues are common enough",
  "closed Thursdays",
  "use the stricter 1.25 by 2.25 by 5.5-inch limit",
  "confuse this free City park with the adjacent commercial ranch",
])
  need(joined.includes(phrase), `Missing Honolulu and Oahu guidance: ${phrase}`);
...
console.log(
  `Verified ${campaign.places.length} Honolulu and Oahu guides with four photos, eight mapped subsites and practical visitor answers.`,
);
